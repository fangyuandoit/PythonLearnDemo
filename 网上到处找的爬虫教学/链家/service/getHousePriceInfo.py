...
from 网上到处找的爬虫教学.链家.dao import HousePriceDao
from 网上到处找的爬虫教学.链家.entity import HouseInfo

# def  getAllHouseNumber():
#     headers = {
#         "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.120 Safari/537.36",
#         "Referer": "https://cd.lianjia.com/ershoufang/co41/",
#         "Host": "cd.lianjia.com"
#     }
#
#     content = requests.get("https://cd.lianjia.com/ershoufang/", headers=headers).content.decode()
#     soup = BeautifulSoup(content, 'html.parser')
#     total_document = soup.find(class_='total fl')
#     print(total_document.span.string)
